                ...
                dataLoading ?
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                        ...
                        <div className='form_group frm-text-conn-stl '>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M12 4H6C4.89543 4 4 4.89543 4 6V18C4 19.1046 4.89543 20 6 20H18C19.1046 20 20 19.1046 20 18V12M9 15V12.5L17.75 3.75C18.4404 3.05964 19.5596 3.05964 20.25 3.75V3.75C20.9404 4.44036 20.9404 5.55964 20.25 6.25L15.5 11L11.5 15H9Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        ...
                        <Grid pb={3}  >
                            <LoadingButton loading={loading} disabled={loading} type='submit' className='cancel-btn' >
                                {
                                    loading ?
                            ...
                            <Button className='save-btn' onClick={handleClose}>Cancel <svg svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
