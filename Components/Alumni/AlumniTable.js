...
import { Add, AssignmentReturn, Autorenew, InfoOutlined, MoreHorizOutlined, SummarizeOutlined } from '@mui/icons-material';
...
export default function AlumniTable({ refresh, editId, setEditId, page, setPage, setRefresh, searchType, nameSearch, searchActive }) {
