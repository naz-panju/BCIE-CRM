...
export default function SubmitToUniversityModal({ details, editId, setEditId, refresh, setRefresh }) {
            ...
            >
                <Grid width={550}>
                    <Grid className='modal_title d-flex align-items-center'>
                        ...
                        <a className='back_modal_head'> Submit Application to University </a>
