                  ...
                  <h4>
                    ...
                    <a className='hide-sec' >
                      <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                        ...
                        <path d="M11.0007 8.00016L8.66732 10.3335L6.33398 8.00016" stroke="#898989" strokeWidth="0.8" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </a>
                  </h4>
                  ...
                  <div>
                    <div className='lead-communication-status'>
                      <h4><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className='lead-ic'>
                        <path d="M7.5 11.25L12.5 13.75M12.5 6.25L7.5 8.75M15 17.5C13.6193 17.5 12.5 16.3807 12.5 15C12.5 13.6193 13.6193 12.5 15 12.5C16.3807 12.5 17.5 13.6193 17.5 15C17.5 16.3807 16.3807 17.5 15 17.5ZM5 12.5C3.61929 12.5 2.5 11.3807 2.5 10C2.5 8.61929 3.61929 7.5 5 7.5C6.38071 7.5 7.5 8.61929 7.5 10C7.5 11.3807 6.38071 12.5 5 12.5ZM15 7.5C13.6193 7.5 12.5 6.38071 12.5 5C12.5 3.61929 13.6193 2.5 15 2.5C16.3807 2.5 17.5 3.61929 17.5 5C17.5 6.38071 16.3807 7.5 15 7.5Z" stroke="#0B0D23" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" />
                      </svg> Lead Source</h4>
