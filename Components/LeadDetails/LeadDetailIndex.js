          ...
          <div className='page-title-block-content justify-between'>
            ...
            <Grid>
...

              {
                ...
                <Button disabled={!details} onClick={details && handleConfirmOpen} variant='contained' className='bg-sky-800 text-white hover:bg-sky-900'>
              ...
              {
                (session?.data?.user?.role?.id == 3 || session?.data?.user?.role?.id == 4) && details?.closed != 1 && details?.completed != 1 &&
