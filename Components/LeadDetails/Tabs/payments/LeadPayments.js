                                                    ...
                                                    <TableCell>
                                                        <Typography className='app-tab-title' variant="subtitle1" sx={{ color: 'black' }} fontWeight="bold">
                                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M1.5 5.25H15M12 1.5L15.75 5.25L12 9M16.5 12.75H3M6 9L2.25 12.75L6 16.5" stroke="black" strokeWidth="1.5" />
                                                            </svg>
                                                            Details
                                                        </Typography>
                                                    </TableCell>
                                                    <TableCell>
                                                        <Typography className='app-tab-title' variant="subtitle1" sx={{ color: 'black' }} fontWeight="bold">
                                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M13.125 16.625C13.125 14.692 10.7745 13.125 7.875 13.125C4.9755 13.125 2.625 14.692 2.625 16.625M18.375 8.75L14.875 12.25L13.125 10.5M7.875 10.5C5.942 10.5 4.375 8.933 4.375 7C4.375 5.067 5.942 3.5 7.875 3.5C9.808 3.5 11.375 5.067 11.375 7C11.375 8.933 9.808 10.5 7.875 10.5Z" stroke="#0B0D23" strokeWidth="1.4" stroke-linecap="round" stroke-linejoin="round" />
                                                            </svg>
                                                            Date & Creator
                                                        </Typography>
                                                    </TableCell>
                                                    ...
                                                    list?.data?.map((obj, index) => (
                                                        <TableRow key={obj?.id}>
                                                            ...
                                                            <TableCell><a href={obj?.receipt_file} target='_blank' style={{ color: blue[700], textDecoration: 'underLine' }} ><svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M4.1582 10.5093L10.478 4.18953C12.3574 2.31013 15.4045 2.31013 17.2839 4.18953C19.1633 6.06893 19.1631 9.1162 17.2837 10.9956L9.99166 18.2876C8.73873 19.5406 6.70767 19.5404 5.45473 18.2875C4.2018 17.0345 4.2015 15.0033 5.45443 13.7504L12.7465 6.45837C13.3729 5.83191 14.3892 5.83191 15.0156 6.45837C15.6421 7.08484 15.6417 8.1003 15.0152 8.72676L8.69543 15.0465" stroke="#0B0D23" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                            </svg>
                                                            </a></TableCell>
