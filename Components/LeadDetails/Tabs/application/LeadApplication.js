...
function LeadApplication({ data, lead_id, handleLeadRefresh }) {
  ...
  <path d="M16.2952 1.50587V4.83041H12.9707" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
                                                    ...
                                                    {/* <TableCell>
                                                        <Typography className='app-tab-title' sx={{ color: 'black' }} fontWeight="bold">
