                                                ...
                                                <TableCell>
                                                    <Typography style={{ color: '#ffffff' }} className='app-tab-title' variant="subtitle1" sx={{ color: 'black' }} fontWeight="bold">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                            ...
                                                            <path d="M16.2952 1.50587V4.83041H12.9707" stroke="#FFFFFF" strokeLinecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                        Uni. Deposit
                                                    </Typography>
                                                </TableCell>
                                                                        ...
                                                                        <div className='appl_act_cntr' >
                                                                            ...
                                                                            <div className='all_act_cntr application'>
                                                                                <div className='application-btn-left'>
                                                                                    ...
                                                                                    <Button className='application-btn Defer-Intake' onClick={() => handleDeferOpen(obj)}  > <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 14 16" fill="none">
