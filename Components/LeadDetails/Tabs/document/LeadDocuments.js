                                ...
                                !documentSelected ?
                                    ...
                                    <>
...

                                        {
                                            ...
                                            <div className='doc-preview-block'>
                                                <div className='doc-req-icon doc-request'>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none"><path d="M20.5 11.9583V20.5H29.0417M20.5 35.875C12.0086 35.875 5.125 28.9914 5.125 20.5C5.125 12.0086 12.0086 5.125 20.5 5.125C28.9914 5.125 35.875 12.0086 35.875 20.5C35.875 28.9914 28.9914 35.875 20.5 35.875Z" stroke="#FEA878" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" /></svg>
                                                </div>
                            ...
                            <div className='degree-block'>
...

                                {
                                    ...
                                    <div className='degree-btn-block'>
                                        <Button disabled={!documentSelected || (!documentSelected?.file && documentSelected?.status == "Requested") || documentSelected?.status == "Accepted" || documentSelected?.status == "Rejected"} onClick={() => handleAccept(documentSelected?.id)} className='degree-btn'>Accept <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none"><path d="M7.875 13.5H19.125M19.125 13.5L14.625 9M19.125 13.5L14.625 18" stroke="white" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg></Button>
                                        <Button disabled={!documentSelected || (!documentSelected?.file && documentSelected?.status == "Requested") || documentSelected?.status == "Accepted" || documentSelected?.status == "Rejected"} onClick={() => handleReject(documentSelected?.id)} className='Reject-btn'>Reject <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M9 9L11.9999 11.9999M11.9999 11.9999L14.9999 14.9999M11.9999 11.9999L9 14.9999M11.9999 11.9999L14.9999 9M4 16.8002V7.2002C4 6.08009 4 5.51962 4.21799 5.0918C4.40973 4.71547 4.71547 4.40973 5.0918 4.21799C5.51962 4 6.08009 4 7.2002 4H16.8002C17.9203 4 18.4801 4 18.9079 4.21799C19.2842 4.40973 19.5905 4.71547 19.7822 5.0918C20.0002 5.51962 20.0002 6.07967 20.0002 7.19978V16.7998C20.0002 17.9199 20.0002 18.48 19.7822 18.9078C19.5905 19.2841 19.2842 19.5905 18.9079 19.7822C18.4805 20 17.9215 20 16.8036 20H7.19691C6.07899 20 5.5192 20 5.0918 19.7822C4.71547 19.5905 4.40973 19.2842 4.21799 18.9079C4 18.4801 4 17.9203 4 16.8002Z" stroke="white" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg></Button>
                                    </div>
                                }
