...
<path d="M20.5 11.9583V20.5H29.0417M20.5 35.875C12.0086 35.875 5.125 28.9914 5.125 20.5C5.125 12.0086 12.0086 5.125 20.5 5.125C28.9914 5.125 35.875 12.0086 35.875 20.5C35.875 28.9914 28.9914 35.875 20.5 35.875Z" stroke="#FEA878" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                            ...
                            <div className='degree-block'>
...

                                {
                                    ...
                                    <div className='degree-btn-block'>
                                        <Button disabled={!documentSelected || (!documentSelected?.file && documentSelected?.status == "Requested") || documentSelected?.status == "Accepted" || documentSelected?.status == "Rejected"} onClick={() => handleAccept(documentSelected?.id)} className='degree-btn'>Accept <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none"><path d="M7.875 13.5H19.125M19.125 13.5L14.625 9M19.125 13.5L14.625 18" stroke="white" strokeWidth="1.5" strokeLinecap="round" stroke-linejoin="round" /></svg></Button>
