...
<label style={{ fontWeight: 'bold' }}>Name </label> <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
  <path d="M16.8333 17.1413C16.2879 14.705 14.2321 13.2694 10.5001 13.2694C6.76817 13.2694 4.71213 14.705 4.16667 17.1413M10.5 19.5341C15.7467 19.5341 20 15.3269 20 10.137C20 4.9472 15.7467 0.73999 10.5 0.73999C5.25329 0.73999 1 4.9472 1 10.137C1 15.3269 5.25329 19.5341 10.5 19.5341ZM10.5 10.137C11.9074 10.137 12.6111 9.39125 12.6111 7.52675C12.6111 5.66226 11.9074 4.91646 10.5 4.91646C9.09259 4.91646 8.38889 5.66226 8.38889 7.52675C8.38889 9.39125 9.09259 10.137 10.5 10.137Z" stroke="#0B0D23" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg> {data?.name}
</div>
</div>
...
<a onClick={handleEdit} className='edit-btn' style={{ cursor: 'pointer' }}> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                loading ?
                    ...
                    <div className='lead-tabpanel-content-item'>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                               ...
                               <div>
                               <div className="lead-details-list">
                            <label style={{ fontWeight: 'bold' }}>Preferred Course </label> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
  <path d="M12 8.00461C10.4414 5.95078 5.80377 5.85119 2 6.84283V20.3579C4.69417 19.1105 9.5481 18.7094 12 20.7913M12 8.00461V20.7913M12 8.00461C13.5586 5.95078 18.1962 5.85119 22 6.84283V20.3579C19.3058 19.1105 14.4519 18.7094 12 20.7913" stroke="#0B0D23" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <path d="M9 4.71826L3 7.68575V20.5449L9 17.5774M9 4.71826V17.5774M9 4.71826L15 7.68575M9 17.5774L15 20.5449M15 20.5449L21 18.5666V5.70743L15 7.68575M15 20.5449V7.68575" stroke="#0B0D23" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg> {data?.state}
                            </div>
                        }
