...
import TemplateTable from './ApplicantsTable';
    ...
    <>
      <section>
        ...
        <div className='content-block'>
          <ApplicantTable editId={editId} setEditId={setEditId} refresh={refresh} setRefresh={setRefresh} page={page} setPage={setPage} />
        </div>
      </section>
    </>
