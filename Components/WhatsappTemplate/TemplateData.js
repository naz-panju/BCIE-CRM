...
function WhatsAppTemplateData({ handleToggleTable, setValue, body, isFocused, setSubject }) {
    ...
    const Datas = [
        ...
        { title: 'Manager Name', key: "{{25}}" },  
        { title: 'Manager Email', key: "{{26}}" }, 
        { title: 'Manager Phone Number', key: "{{27}}" }, 
        { title: 'Manager Address', key: "{{28}}" }, 
    ];
            ...
            <Grid className='modal_title d-flex align-items-center  '>
                ...
                <a className='back_modal' onClick={handleToggleTable}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewBox="0 0 31 31" fill="none">
                        <path d="M9.0415 15.5H21.9582M21.9582 15.5L16.7918 20.6666M21.9582 15.5L16.7918 10.3333" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
