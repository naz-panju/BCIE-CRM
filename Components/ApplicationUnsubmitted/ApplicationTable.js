                    ...
                    <div>
                        <div className='form-group'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="18" viewBox="0 0 16 18" fill="none" className='sear-ic'>
                                <path d="M13 17C14.1046 17 15.0454 16.0899 14.7951 15.0141C14.1723 12.338 12.0897 11 8 11C3.91032 11 1.8277 12.338 1.20492 15.0141C0.954552 16.0899 1.89543 17 3 17H13Z" stroke="#0B0D23" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M8 8C10 8 11 7 11 4.5C11 2 10 1 8 1C6 1 5 2 5 4.5C5 7 6 8 8 8Z" stroke="#0B0D23" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <AsyncSelect
                                isClearable
                                defaultOptions
                    ...
                    <div>
                        <div className='form-group'>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" viewBox="0 0 20 14" fill="none" className='sear-ic'>
                                <path d="M19 9.00012L10 13.0001L1 9.00012M19 5.00012L10 9.00012L1 5.00012L10 1.00012L19 5.00012Z" stroke="#0B0D23" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <AsyncSelect
                                isClearable
                                defaultOptions
                    ...
                    <div>
                        <div className='form-group'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none" className='sear-ic'>
                                <path d="M2.625 7L9.3906 11.5104C10.0624 11.9583 10.9376 11.9583 11.6094 11.5104L18.375 7M4.625 16.625H16.375C17.4796 16.625 18.375 15.7296 18.375 14.625V6.375C18.375 5.27043 17.4796 4.375 16.375 4.375H4.625C3.52043 4.375 2.625 5.27043 2.625 6.375V14.625C2.625 15.7296 3.52043 16.625 4.625 16.625Z" stroke="#0B0D23" strokeWidth="1.8" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <TextField
                                fullWidth
                    ...
                    <div>
                        <div className='form-btn-cntr d-flex align-items-center justify-content-between '>
                            ...
                            <Button className='fill-btn-clear' onClick={handleClearSearch} ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <path d="M14 14L8.00002 8.00002M8.00002 8.00002L2 2M8.00002 8.00002L14 2M8.00002 8.00002L2 14" stroke="white" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg> Clear</Button>
                        </div>
                    </div>
                                                                    ...
                                                                    <Grid display={'flex'} alignItems={'center'}>
                                                                        ...
                                                                        <Tooltip title={'Mail to University'}>
                                                                            <svg style={{ cursor: 'pointer', marginLeft: 8 }} onClick={() => handleMailOpen(row)} xmlns="http://www.w3.org/2000/svg" width="18" height="14" viewBox="0 0 18 14" fill="none">
                                                                                <path d="M1 3.57143L7.91849 8.01903C8.5773 8.44255 9.4227 8.44255 10.0815 8.01903L17 3.57143M3 13H15C16.1046 13 17 12.1046 17 11V3C17 1.89543 16.1046 1 15 1H3C1.89543 1 1 1.89543 1 3V11C1 12.1046 1.89543 13 3 13Z" stroke="#0B0D23" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                                            </svg>
                                                                        </Tooltip>
