            ...
            <form onSubmit={handleSubmit} className="login-form">
                ...
                <div className="input-group">
                    ...
                    <svg onClick={() => setpasswordType(!passwordType)} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className='lg-ic2'>
                        <path d="M3.58631 13.7788C5.36575 15.5478 8.46904 17.9999 11.9997 17.9999C15.5303 17.9999 18.6331 15.5478 20.4125 13.7788C20.8818 13.3123 21.1172 13.0782 21.2667 12.6201C21.3733 12.2933 21.3733 11.7067 21.2667 11.3799C21.1172 10.9218 20.8818 10.6877 20.4125 10.2211C18.633 8.45208 15.5303 6 11.9997 6C8.46904 6 5.36575 8.45208 3.58631 10.2211C3.11665 10.688 2.8818 10.9216 2.73231 11.3799C2.62569 11.7067 2.62569 12.2933 2.73231 12.6201C2.8818 13.0784 3.11665 13.3119 3.58631 13.7788Z" stroke="#CDCDCD" strokeWidth="2" strokeLinecap="round" stroke-linejoin="round" />
                        <path d="M9.99951 12C9.99951 13.1046 10.8949 14 11.9995 14C13.1041 14 13.9995 13.1046 13.9995 12C13.9995 10.8954 13.1041 10 11.9995 10C10.8949 10 9.99951 10.8954 9.99951 12Z" stroke="#CDCDCD" strokeWidth="2" strokeLinecap="round" stroke-linejoin="round" />
                    </svg>
                ...
                <button disabled={loading} type="submit">
                    {
                        ...
                        <path d="M11.375 19.5H27.625M27.625 19.5L21.125 13M27.625 19.5L21.125 26" stroke="white" strokeWidth="1.5" strokeLinecap="round" stroke-linejoin="round" />
                    </svg>
                </button>
