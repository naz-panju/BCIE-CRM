...
export default function ArchiveTable({ refresh, page, setPage, selected, setSelected, openAssign, handleEditAssign, searchactive }) {
  ...
  const handleChangePage = (event, newPage) => {
    ...
    router.replace(`/archive?page=${newPage}`);
  };
                            ...
                            return (
                              ...
                              >
                                ...
                                <TableCell align="left" className='assigned-colm'>
                                  ...
                                  {
                                    row?.assignedToCounsellor ?
                                      <Button disabled onClick={() => handleEditAssign(row)} style={{ color: 'blue', textTransform: 'none' }} >{row?.assignedToCounsellor?.name}</Button>
                                      :
                                      <Button disabled className='not_assigned' sx={{ textTransform: 'none' }} onClick={() => openAssign(row?.id)}>Not Assigned</Button>
                                  }
                            ...
                            >
                              <TableCell colSpan={8} align="center">
                                <div className='no-table-ask-block'>
                                  <h4 style={{ color: 'grey' }}>No Archives Found</h4>
                                </div>
                              </TableCell>
                            </TableRow>
                          )
